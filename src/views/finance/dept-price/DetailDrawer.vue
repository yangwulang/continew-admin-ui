<template>
  <a-drawer v-model:visible="visible" title="部门物料价格详情" :width="width >= 600 ? 600 : '100%'" :footer="false">
    <a-descriptions :column="2" size="large" class="general-description">
      <a-descriptions-item label="部门">{{ dataDetail?.deptName }}</a-descriptions-item>
...
import { type FinDeptMaterialPriceDetailResp, getFinDeptMaterialPrice as getDetail } from '@/apis/finance/fin-dept-material-price'

const { width } = useWindowSize()

const dataId = ref('')
const dataDetail = ref<FinDeptMaterialPriceDetailResp>()
